...
class Splash extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: buildContainer(size, colorFont, context),
      ),
    );
  }

  Container buildContainer(Size size, Color colorFont, BuildContext context) {
    return Container(
      width: size.width,
      height: size.height,
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: colorFont, fontSize: 30, fontWeight: FontWeight.bold),
            ),
          ),
          ElevatedButton(
